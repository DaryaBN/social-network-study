...
const PostList = ({ todosProps }) => {
    const Info = todosProps.map((item) => (
            ...
            <div className="PostLogic">
                ...
                <div className="PostInfo">
                    <div className="InfoData">
                        ...
                        <p className="PostTime">{time(Math.round((new Date().getTime() - new Date(item.time).getTime())/ 60000))}</p>
                    </div>
