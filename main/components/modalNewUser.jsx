...
const ModalNewUser = ({ activeNewUser, setActiveNewUser }) => {
	...
	const [textErrorBoxPassworConfirmation, settextErrorBoxPassworConfirmation] =
		useState(true);
	...
	const [errorColorPassworConfirmation, setErrorColorPassworConfirmation] =
		useState(true);
	...
	return (
		<div
			className={activeNewUser ? "modal active" : "modal"}
			...
			>
				<form onSubmit={handleSubmit}>
					...
					<div className="boxError">
						{textErrorBoxName ? "" : "Поле не заполненно"}
					</div>
					<label className={errorColorName ? "box" : "box borderError"}>
						...
						<div className="emailError">
							{nameErrorBlok ? "" : "Никнейм не валиден"}
						</div>
					</label>
					<div className="boxError">
						{textErrorBoxEmail ? "" : "Поле не заполненно"}
					</div>
					<label className={errorColorEmail ? "box" : "box borderError"}>
						...
						<div className="emailError">
							{emailErrorBlok ? "" : "Адрес не валиден"}
						</div>
					</label>
					<div className="boxError">
						{textErrorBoxPassword ? "" : "Поле не заполненно"}
					</div>
					...
					<div className="boxError">
						{textErrorBoxPassworConfirmation ? "" : "Поле не заполненно"}
					</div>
					<label
						className={
							errorColorPassworConfirmation ? "box" : "box borderError"
						}
					>
						...
						<div className="boxInput">
							<input
								...
								type="password"
								value={state.passworConfirmation}
								placeholder="Подтверждение пароля"
								onChange={handleChange}
							/>
						</div>
						<div className="emailError">
							{passwordError ? "" : "К сожалению, пароли не совпадают"}
						</div>
					</label>
